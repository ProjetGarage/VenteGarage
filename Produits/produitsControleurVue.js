...
function afficherTous(fiches){
    ...
    rep+="                      <input class='form-control' type='text' id='id_prod_mod' name='id_prod_mod' style='visibility:hidden' required> ";
    rep+="                      <input placeholder='Nom Produit' class='form-control' type='text' id='nomProduit_mod' name='nomProduit_mod' style='visibility:hidden' required> ";
    rep+="                     <input class='form-control' type='number' step='0.01' id='quantiteProd_mod' name='quantiteProd_mod' required>";
    ...
    rep+="                            <option value='Science Fiction'>Science Fiction</option> ";
    rep+="                          </select> ";
    rep+="                    <select placeholder='Categorie Produit' class='form-control col-sd-3' id='evenementPr_mod' name='evenementPr_mod'> ";
    rep+="                            <option value='Action'>Action</option> ";
    rep+="                            <option value='Comedy'>Comedy</option> ";
    rep+="                            <option value='Drame'>Drame</option> ";
    rep+="                            <option value='Enfants'>Enfants</option> ";
    rep+="                            <option value='Science Fiction'>Science Fiction</option> ";
    rep+="                          </select> ";
    rep+="                        <input type='number' id='statut_mod' class='form-control' name='statut_mod' placeholder='Statut du produit' size='1' required> ";
    rep+="                        <p id='srctxt' name='srctxt'></p><input class='form-control' type='file' id='photoProd_mod' name='photoProd_mod' placeholder='Photo'> ";
    rep+="                        <input size='255' maxlength='255' type='textarea' class='form-control' placeholder='Description de produit' id='descriptionProd_mod'  name='descriptionProd_mod'> ";
    rep+="                            <div class='modal-footer'> ";
